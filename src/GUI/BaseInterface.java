 ...
 * Class créée afin d'avoir un design de base pour toutes les interfaces avec JFrame
 */
...
public class BaseInterface extends JFrame {
	...
	public BaseInterface(InterfacePrincipale interfacePrinci) {
		...
		// Le panel de centre est ajouté séparément dans les autres inferfaces afin de pouvoir ajouter ce que l'on veut au centre.	
	}
	...
	private void setTimer(){
		timer.scheduleAtFixedRate(new TimerTask() {
			public void run() {
				heure.setText(BaseInterface.this.getTime());
			}
		}, 1000, 1000);
	}
